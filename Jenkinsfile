	...
	stage('Checkout Project') {
		...
		/* stage('Sonarqube') {
		    ...
		    steps {
			    ...
			    bat 'dir' 
			 withSonarQubeEnv('SonarQube') {
				 bat "${scannerHome}/bin/sonar-scanner -X -Dsonar.host.url=https://github.com/Silviagminguez/sonar-properties -Dproject.settings=sonar-scanner-wefferent.properties"
			}
		   }
		 }
